...
const ChangePassword = () => {
  ...
  const { id } = useParams();
  const checkChange = useSelector((state) => state.change_password);
  ...
  const postData = (event) => {
    ...
    setInputData({ ...inputData, new_password: "", password: "" });
  };
  window.scrollTo(0, 0);
  return (
